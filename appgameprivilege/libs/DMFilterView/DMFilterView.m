...
{
    NSAssert(strings.count <= 5, @"only support less than 5 titles");
...
- (void)setSelectedItemBackgroundImage:(UIImage *)selectedItemBackgroundImage
{
    ...
    [self.selectedBackgroundImageView setContentMode:UIViewContentModeScaleAspectFit];//UIViewContentModeScaleToFill
    self.selectedBackgroundImageView.clipsToBounds  = YES;
    [self.selectedBackgroundImageView setContentScaleFactor:[[UIScreen mainScreen] scale]];
    [self.selectedBackgroundImageView setBackgroundColor:[UIColor clearColor]];//lightGrayColor
