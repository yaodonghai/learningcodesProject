...
@synthesize userDescription,userHead,userId,userNickname,roomFlag,thenewMsgs,timeCreate;
...
//    [user setUserId:[[aDic objectForKey:kUSER_ID]stringValue]];
    ...
    user.thenewMsgs = [aDic objectForKey:kUSER_NEW_MSGS];
...
{
    NSDictionary *dic=[NSDictionary dictionaryWithObjectsAndKeys:userId,kUSER_ID,userNickname,kUSER_NICKNAME,userDescription,kUSER_DESCRIPTION,userHead,kUSER_USERHEAD,roomFlag,kUSER_ROOM_FLAG,thenewMsgs,kUSER_NEW_MSGS,nil];
    return dic;
}
